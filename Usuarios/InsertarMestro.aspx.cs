...
public partial class Clientes_Insertar : System.Web.UI.Page
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        if ((cnn = agrega.ConectarBase()) != null)
        {
            ...
            MyCommand = agrega.ActualizaCmd("Insert into Maestro (Nombre, ApPaterno,ApMaterno,FechaNac,Direccion,Telefono,Sexo,Email,contrasena ) values ( @Nombre, @ApPaterno, @ApMaterno, @FechaNac,@Direccion,@Telefono,@Sexo,@Email,@contrasena)");
