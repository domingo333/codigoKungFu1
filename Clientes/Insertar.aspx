<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage3.master" AutoEventWireup="true" CodeFile="Insertar.aspx.cs" Inherits="Clientes_Insertar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="Label1" runat="server" Text="Id: "></asp:Label>
        <br />
        <table class="auto-style1" style="font-family: 'Arial Rounded MT Bold'; background-color: #FFFFFF; border-style: double; color: #FF0000;">
            <tr>
    ...
    <asp:Label ID="Label9" runat="server" Text="Documento :"></asp:Label>
                ...
                <td class="auto-style4">
                    <asp:DropDownList ID="DropDownList1" runat="server">
                        ...
                        <asp:ListItem>Curp</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
